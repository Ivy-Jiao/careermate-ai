console.log('CareerMate AI Landing Page loaded successfully! 🚀');console.log('CareerMate AI Landing Page loaded successfully! 🚀');
...
const Formvalidator = {
    ...
    validateField(field) {
        ...
        if (rule.minLength && fieldvalue.length < rule.minLength) {
            this.showError(field, rule.message)
            return false // form can not be submitted untill user change to right input
        }
